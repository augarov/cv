...
from pydantic import BaseModel, EmailStr, HttpUrl, Field, field_validator, BeforeValidator, model_validator
...
class MarkdownText(BaseModel):
    ...
    ast: List[Dict[str, Any]] = Field(default_factory=list, description="Parsed AST representation")
...
class Name(BaseModel):
    ...
    first: StrippedStr = Field(..., min_length=1, max_length=500)
    last: StrippedStr = Field(..., min_length=1, max_length=500)
...
class Personal(BaseModel):
    ...
    name: Name
    title: StrippedStr = Field(..., min_length=1, max_length=500)
    summary: MarkdownText = Field(..., description="Personal summary with markdown support")
    location: StrippedStr = Field(..., min_length=1, max_length=500)
    contact: Contact
...
class Language(BaseModel):
    ...
    language: StrippedStr = Field(..., min_length=1, max_length=500)
    level: StrippedStr = Field(..., min_length=1, max_length=500)


class GPA(BaseModel):
    """Model for GPA information."""

    cumulative: StrippedStr = Field(..., min_length=1, max_length=100)
    major: StrippedStr = Field(..., min_length=1, max_length=100)


class Education(BaseModel):
    """Model for education entry."""

    institution: StrippedStr = Field(..., min_length=1, max_length=500)
    degree: StrippedStr = Field(..., min_length=1, max_length=500)
    period: StrippedStr = Field(..., min_length=1, max_length=200)
    location: StrippedStr = Field(..., min_length=1, max_length=500)
    specialization: StrippedStr = Field(..., min_length=1, max_length=500)
    focus: StrippedStr = Field(..., min_length=1, max_length=500)
    gpa: GPA
...
class Experience(BaseModel):
    ...
    company: StrippedStr = Field(..., min_length=1, max_length=500)
    position: StrippedStr = Field(..., min_length=1, max_length=500)
    period: StrippedStr = Field(..., min_length=1, max_length=200)
    location: StrippedStr = Field(..., min_length=1, max_length=500)
    description: MarkdownText = Field(..., description="Job description with markdown support")
    achievements: List[MarkdownText] = Field(..., min_length=1, description="List of achievements with markdown support")
    stack: StrippedStr = Field(..., min_length=1, max_length=1000)
...
class Metadata(BaseModel):
    ...
    pdf_title: StrippedStr = Field(..., min_length=1, max_length=500)
    pdf_author: StrippedStr = Field(..., min_length=1, max_length=500)
    pdf_subject: StrippedStr = Field(..., min_length=1, max_length=500)
    pdf_keywords: StrippedStr = Field(..., min_length=1, max_length=1000)


class SkillCategory(BaseModel):
    """Model for a skill category with its associated skills."""

    category: StrippedStr = Field(..., min_length=1, max_length=500)
