...
% Note: Don't forget to update the metadata in HTML.
\hypersetup{
    pdftitle={C++ Software Engineer - Anton Ugarov},
    pdfauthor={Anton Ugarov},
    pdfsubject={CV/Resume},
    pdfkeywords={c++, software engineer, cv, resume},
}
...
\descript{| Senior Software Engineer, Team Lead}
